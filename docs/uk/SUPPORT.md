...
Дякуємо, що користуєтеся **B19/Go**!
Цей документ пояснює, де шукати допомогу та як ставити зрозумілі запитання.

## Куди звертатися

- **Повідомити про відтворювану ваду** — [Issues on Codeberg](https://codeberg.org/b19/go/issues)
- **Повідомити про відтворювану ваду** — [Issues on GitHub](https://github.com/damian-buho/b19-go/issues)
...
4. **Середовище** — операційна система, версія B19/Go, версія середовища виконання.
