...
¡Gracias por usar **B19/Go**!
Este documento explica dónde conseguir ayuda y cómo formular buenas preguntas.

## Dónde preguntar

- **Informar de un fallo reproducible** — [Issues on Codeberg](https://codeberg.org/b19/go/issues)
- **Informar de un fallo reproducible** — [Issues on GitHub](https://github.com/damian-buho/b19-go/issues)
...
4. **Entorno** — sistema operativo, versión de B19/Go, versión del entorno de ejecución.
