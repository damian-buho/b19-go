...
Usamos [Issues de Codeberg](https://codeberg.org/b19/go/issues) para seguir fallos y errores. Si te topas con un problema en el proyecto:
...
- **Explica por qué esta mejora sería útil** para quienes usan B19/Go. También puedes señalar otros proyectos que lo hayan resuelto mejor y que sirvan de inspiración.
