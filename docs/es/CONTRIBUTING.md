...
>
> - Dale una estrella al proyecto en [codeberg.org](https://codeberg.org/b19/go)
> - Dale una estrella al proyecto en [github.com](https://github.com/damian-buho/b19-go)
...
- Para ver si otras personas han tenido (y quizá ya resuelto) el mismo problema, comprueba que no exista ya un informe de tu fallo o error en el [gestor de incidencias](https://codeberg.org/b19/go/issues?q=label%3Abug).
...
Usamos [incidencias](https://codeberg.org/b19/go/issues) para seguir fallos y errores. Si te topas con un problema en el proyecto:

- Abre una [incidencia](https://codeberg.org/b19/go/issues/new). (Como todavía no podemos saber si se trata de un fallo, te pedimos que no lo des por hecho ni etiquetes la incidencia.)
...
Esta sección te guía para enviar una propuesta de mejora para B19/Go, **tanto funcionalidades completamente nuevas como pequeñas mejoras de lo existente**. Seguir estas indicaciones ayudará a quienes mantienen el proyecto y a la comunidad a entender tu propuesta y a encontrar sugerencias relacionadas.
...
- Haz una [búsqueda](https://codeberg.org/b19/go/issues) para ver si ya se ha propuesto. Si es así, comenta en la incidencia existente en lugar de abrir una nueva.
...
Las propuestas de mejora se gestionan como [incidencias](https://codeberg.org/b19/go/issues).
...
- **Explica por qué esta mejora sería útil** para la mayoría de quienes usan B19/Go. También puedes señalar otros proyectos que lo hayan resuelto mejor y que sirvan de inspiración.
